...
void sound(int c)
{
  ...
  if(c==0)
   soundFilePath = "./Sound Files/Mysterious_temple_long.mp3";  //Background score
  else if(c==1)
   soundFilePath = "./Sound Files/hangman_rope.mp3"; //Rope sound
  else if(c==2)
   soundFilePath = "./Sound Files/Man_scream.mp3"; //Death sound
  else if(c==3)
   soundFilePath = "./Sound Files/yes_man.mp3";  //Yes sound
  else if(c==4)
   soundFilePath= "./Sound Files/success.mp3"; //Success sound
